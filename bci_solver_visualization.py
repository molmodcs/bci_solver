...
def bci_solver_visualizer(mol2_folder_path,list_of_atom_types=None,q0=None,list_of_names=None,dpi_value=100,output_folder=None,show_atom_symbol=True,show_atom_type=False,
                          save_fig=True):
...
def bci_solver_hist_visualizer(mol2_folder_path,list_of_atom_types=None,q0=None,list_of_names=None,dpi_value=100,output_folder=None,show_atom_symbol=True,show_atom_type=False,
                          save_fig=True):
